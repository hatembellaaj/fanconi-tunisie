...
import { sampleWithNewData, sampleWithRequiredData } from '../membre.test-samples';
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            nDossierM: expect.any(Object),
            idMembre: expect.any(Object),
            prenomM: expect.any(Object),
            lienParente: expect.any(Object),
            typeCancerM: expect.any(Object),
            ageDecouverteM: expect.any(Object),
          }),
        );
      });
