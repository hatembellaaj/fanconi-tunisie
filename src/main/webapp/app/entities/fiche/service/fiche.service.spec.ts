...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../fiche.test-samples';

import { FicheService, RestFiche } from './fiche.service';

const requireRestSample: RestFiche = {
  ...sampleWithRequiredData,
  dateDiagnostic: sampleWithRequiredData.dateDiagnostic?.format(DATE_FORMAT),
  dateEnregistrement: sampleWithRequiredData.dateEnregistrement?.format(DATE_FORMAT),
  dateNumSanguine: sampleWithRequiredData.dateNumSanguine?.format(DATE_FORMAT),
  androDebut: sampleWithRequiredData.androDebut?.format(DATE_FORMAT),
  androFin: sampleWithRequiredData.androFin?.format(DATE_FORMAT),
  dDN: sampleWithRequiredData.dDN?.format(DATE_FORMAT),
