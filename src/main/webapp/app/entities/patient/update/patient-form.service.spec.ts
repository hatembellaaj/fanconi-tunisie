      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            reperes: expect.any(Object),
            tel: expect.any(Object),
            prenomPere: expect.any(Object),
            nomMere: expect.any(Object),
            prenomMere: expect.any(Object),
            nomGMP: expect.any(Object),
            nomGMM: expect.any(Object),
