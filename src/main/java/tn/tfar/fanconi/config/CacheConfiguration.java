...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tn.tfar.fanconi.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tn.tfar.fanconi.repository.UserRepository.USERS_BY_EMAIL_CACHE);
