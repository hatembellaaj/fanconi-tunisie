...
/**
 * REST controller for managing {@link tn.tfar.fanconi.domain.Service}.
 */
@RestController
...
public class ServiceResource {
    ...
    public ResponseEntity<Service> partialUpdateService(
        ...
        Optional<Service> result = serviceRepository
            ...
            .map(existingService -> {
                if (service.getCodeService() != null) {
                    existingService.setCodeService(service.getCodeService());
                }
                if (service.getNomService() != null) {
